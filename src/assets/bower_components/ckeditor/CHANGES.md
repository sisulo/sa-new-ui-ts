...
* [#11490](https://dev.ckeditor.com/ticket/11490): Fixed: [Menu.ts button](https://ckeditor.com/cke4/addon/menubutton) panel not showing in the source mode.
...
* [#10856](https://dev.ckeditor.com/ticket/10856): Menu.ts buttons will now toggle the visibility of their panels when clicked multiple times. [Language](https://ckeditor.com/cke4/addon/language) plugin fixes: Added active language highlighting, added an option to remove the language.
